...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """ask""", """controllers.HomeController.ask"""),
  ...
  // @LINE:9
  private lazy val controllers_HomeController_ask3_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("ask")))
  )
  private lazy val controllers_HomeController_ask3_invoker = createInvoker(
    HomeController_0.ask,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "ask",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:9
    case controllers_HomeController_ask3_route(params@_) =>
      call { 
        controllers_HomeController_ask3_invoker.call(HomeController_0.ask)
      }
